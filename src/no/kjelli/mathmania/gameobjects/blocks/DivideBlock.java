...
public class DivideBlock extends AbstractBlock {
	...
	public static final int base_x = 32, base_y = 32;

	public DivideBlock(int x_index, int y_index, int difficulty, int encryptKey) {
	...
	public Question getQuestion() {
		return new Question(Question.TYPE.DIVIDE, difficulty,  isEncrypted(),this);
	}
