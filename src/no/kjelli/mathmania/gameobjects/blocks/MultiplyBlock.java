...
public class MultiplyBlock extends AbstractBlock {
	...
	public static final int base_x = 64, base_y = 32;

	public MultiplyBlock(int x_index, int y_index, int difficulty, int encryptKey) {
	...
	public Question getQuestion() {
		return new Question(Question.TYPE.MULTIPLY, difficulty, isEncrypted(), this);
	}
